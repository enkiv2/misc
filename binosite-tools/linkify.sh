...
for i in part?/Page*.htm; do 
	...
	sed -i 's|BIG &amp; SMALL #1|<a href="/part4/Page3708.htm">BIG &amp; SMALL #1</a>|g' $i ; printf .
	sed -i 's|BIG &amp; SMALL #2|<a href="/part4/Page3802.htm">BIG &amp; SMALL #2</a>|g' $i ; printf .
	sed -i 's|BIG &amp; SMALL #3|<a href="/part4/Page3552.htm">BIG &amp; SMALL #3</a>|g' $i ; printf .
	sed -i 's|BIG &amp; SMALL #4|<a href="/part4/Page6190.htm">BIG &amp; SMALL #4</a>|g' $i ; printf .
	sed -i 's|BIG &amp; SMALL #5|<a href="/part4/Page994.htm">BIG &amp; SMALL #5</a>|g' $i ; printf .
	sed -i 's|BIG &amp; SMALL #6|<a href="/part4/Page1585.htm">BIG &amp; SMALL #6</a>|g' $i ; printf .
	...
	sed -i 's|OTHER BINOCULARS #1|<a href="/part4/Page21222.htm">OTHER BINOCULARS #1</a>|g' $i ; printf .
	sed -i 's|OTHER BINOCULARS #2|<a href="/part4/Page2762.htm">OTHER BINOCULARS #2</a>|g' $i ; printf .
	sed -i 's|OTHER BINOCULARS #3|<a href="/part4/Page3047.htm">OTHER BINOCULARS #3</a>|g' $i ; printf .
	sed -i 's|OTHER BINOCULARS #4|<a href="/part4/Page3260.htm">OTHER BINOCULARS #4</a>|g' $i ; printf .
	sed -i 's|OTHER BINOCULARS #5|<a href="/part4/Page3540.htm">OTHER BINOCULARS #5</a>|g' $i ; printf .
	sed -i 's|OTHER BINOCULARS #6|<a href="/part4/Page3595.htm">OTHER BINOCULARS #6</a>|g' $i ; printf .
	sed -i 's|OTHER BINOCULARS #7|<a href="/part4/Page4610.htm">OTHER BINOCULARS #7</a>|g' $i ; printf .
	sed -i 's|OTHER BINOCULARS #8|<a href="/part4/Page3090.htm">OTHER BINOCULARS #8</a>|g' $i ; printf .
	sed -i 's|OTHER BINOCULARS #9|<a href="/part4/Page4508.htm">OTHER BINOCULARS #9</a>|g' $i ; printf .

...
define config.name = _("Freddy Kuroki vs The Unseen World")
...
define gui.about = _p("""
In 1985, Fyodor 'Freddy' Kuroki purchased a Macintosh and began transplanting his extensive UFO case files to an experimental hypertext system that one of his graduate students at Warwick had written. This system, called {a=jump:sAboutHyperNote}HyperNote{/a}, was never made commercially available, but Kuroki continued to intermittently maintain and extend it for his own use. When he died in 2013, his estate was donated to Keio University's library archives. In 2016, a group of graduate student researchers ported the Hypernote database to work on modern computers, and gave it the name Kuroki had (in a 1968 lecture) jokingly claimed would be the title of his magnum opus, {i}Freddy Kuroki vs The Unseen World{/i}.
...
define build.name = "FreddyKurokivsTheUnseenWorld"
...
define config.save_directory = "FreddyKurokivsTheUnseenWorld-1644719412"
...
define build.itch_project = "enkiv2/freddy-kuroki-vs-the-unseen-world"

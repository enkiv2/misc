...
screen about():
    ...
    use game_menu(_("About"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("\"Rain, Car Interior, A.wav\" by InspectorJ (www.jshaw.co.uk) of Freesound.org")
...
screen encyclopedia:
    ...
    use game_menu(_("Encyclopedia"), scroll="viewport"):
        ...
        vbox:
            ...
            label ("""{b}Cultural and Localization Notes{/b}

{i}The {/i}Yomiyama FLAP{i} series is set in Japan, and while I am not Japanese, I have made an effort to keep cultural elements accurate or to justify any inaccuracies I found necessary for the sake of storytelling. This means that some things mentioned in the story will not necessarily be familiar to western audiences (and while this story is very much set in the kind of warped version of Japan seen in anime, readers may nevertheless be confused).
...
I am providing the following notes for the sake of such a general audience.

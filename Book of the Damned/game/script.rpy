...
label badEnd:
    call staticOut
    n "I'm sorry, [name]. Umeji Misato has died, and your connection to her was severed."
    n "It is still possible to restart the cyranoid daemon and connect to an earlier time point."

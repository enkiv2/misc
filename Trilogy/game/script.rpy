...
label lazarus_pose:
    ...
    extend "The scale and suddenness of this event exposed the the internet cranks’ claims of international conspiracy as wishful thinking."
    extend "Much speculation about the evidence caught on radar and sattelite imagery has occurred, but to my knowledge, I am the only one to directly investigate the black squares."
    scene  rocket
    quote  "Let me first reiterate the obvious:"
    extend "the Heart of Gold was the largest, fastest space vehicle humans have ever built by a large margin, and took a great deal of time and capital."
    extend "It was one month into the three month trip."
    extend "The things that intercepted it were of comparable size, and the time from when the squares in Siberia and the Outback first appeared and impact was only twenty minutes."
    extend "This was not part of the abandoned Soviet Dead Hand interception system; the Soviets could not have built a device this size."
    scene  twitter
...
label house_on_foulness:
    ...
    extend "I have taken the position of governess to a pair of children, at an estate on the coast, in a town called Foulness. What a queer name! I shall be travelling there for most of tomorrow. In this way, I squirrel away savings for the trip."
    quote  "3rd April, 1919"
    extend "My dearest Mary,"
    ...
    extend "The estate where I will be working is on a small rocky island across the marsh, and a low bridge of stones apparently connects it to the town proper, though this is now covered by the tides. There is no ferry out, and no dock on the other side. I will be taking that bridge in the morning."
    quote  "4th April, 1919"
    extend "Mary,"
    extend "At long last, I have arrived at the estate proper — just as the maid was leaving. I presume that the bridge is so low as to be submerged most of the time, and the household is careful to cross in and out of town as close to low tide as possible so as to not be caught out."
    ...
    extend "I later determined that this must have been the boy, Terence, who is twelve — that age when boys make sport of poking dead things with sticks. He does not seem abnormally unruly for a boy of twelve. His sister, Anna, is only four but preternaturally calm."
    ...
    extend "I requested she pick up some groceries — eggs, fresh fruit and vegetables if she can find any, and flour, since the bag left here has been invaded by some unfamiliar marsh-insect. She will bring them tomorrow morning."
    ...
    extend "After supper, the children and I sat by the little stove in the centre of the ground floor landing and I read them a story. Then, Anna said something strange. She said, “Mama says she likes you.” Young children often have vivid imaginations, and so I dismissed it, but her face had that same seriousness."
    quote  "6th April, 1919"
    extend "When Mrs Grant came (thankfully hauling flour and eggs, although no fruit and only some meagre-looking withered vegetables unsuitable for pickling), I asked her if Anna had been close to her mother. “Oh dear no,” she said. “Mrs Marsten, god rest her soul, died giving birth to Anna, who never knew her mother.” This lifted a weight from my heart. Anna is not seeing her mother out of trauma — she has no concept of what it’s like to have one, and so an imaginary mother is no different from an imaginary aardvark or some other fantastical creature a child might pretend about. Mrs Grant also lifted my spirits with regard to the water damage from the radiators, saying that the house is mostly cedar and gets far worse from the surf — everything dries out in the summer, when it is even hotter during the day than it is now, and the copper roof practically bakes the steam out of the whole house."
    extend "Terence was even busier at Anna’s game today than usual. When the wind was right, I heard her preface her orders with something like “Mama says”. Perhaps this is not an imaginary friend at all, but merely a part of the game they invented together."
    ...
    extend "I found him laid out on one of the stone steps, the water line up to his ears, flushed and warm to the touch, & carried him in. As I did, I thought I saw a light in the small parapet atop the roof."
    extend "I tended to his fever with cool, damp rags, until Anna told me “Mama said use the paracetamol”. I did, and his fever broke, though he didn’t wake up."
    ...
    extend "I told Mrs Grant about Anna’s strange prescription, and she looked slightly disturbed. She said, “Anna never called her mother ‘Mama’.” After all, she had never had a mother. Instead, that had been Anna’s pet name for the previous governess, who had come nearly four years ago and stayed until recently. “Mama Mary.” I did not say that I had a childhood friend named Mary; it is, after all, a common name!"
    ...
    extend "After Mrs Grant left, Anna continued ordering me about — “Mama says fill the bathtub with cold water”, “Mama says take in all the towels off the line”. I played along."
    extend "I must have tired myself out, because I found myself dozing before the stove late in the evening, after I would have normally gone to bed. I heard a creaking above me, and a pair of soft voices from the radiator."
    extend "One was rambling on and on and periodically giving orders, while the other was giving short responses. I identified the one giving short responses as Anna."
    ...
    extend "The rambler went on and on like this, and I tried to transcribe more, but the more closely I listen to the echoes in the radiator, the sleepier I get. Perhaps I, too, have become feverish and delirious? I will finish this letter and go to bed."
    ...
    extend "I heard the front door open, and the worms began evacuating his body, pouring out of the tub onto a line of fresh, dry towels laid out on the floor — a pathway to the doorway, where Anna stood in her nightgown in the pouring rain. I watched them march out, down the steps, and into the moonlit marsh clay, which had risen up above the water line. The worms scattered out, created each a tiny hole, and dove in."
    extend "“Mama wants you to understand,” Anna said. “Mama is mama now, and Mary too, and even Papa’s Mama.” I was too Vaguely Surprised to respond."

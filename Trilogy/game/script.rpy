...
label house_on_foulness:
    ...
    quote  "{i}{space=1}You must let him ripen and the seeds burst out into the water.{/i}"
    quote  "{i}{space=1}Do not be afraid of it.{/i}"
    quote  "{i}{space=1}He will burst so that you will not.{/i}"
    quote  "{i}{space=1}It is only his blood that is wrong.{/i}"
    quote  "{i}{space=1}He cannot become one of us.{/i}"
    quote  "{i}{space=1}When he is ripened, let him go.{/i}\""
    nvl clear
